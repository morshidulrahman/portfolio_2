    ...
    <div className='flex flex-wrap justify-between items-center w-full gap-12 md:gap-0'>
      {
        blogs?.map((item, index) => (
          <div
            key={index}
            className=" w-[80%] md:w-[31%] rounded-lg overflow-hidden bg-white dark:bg-transparent shadow-lg hover:-translate-y-3 duration-500 relative mx-auto cursor-pointer"
          >
